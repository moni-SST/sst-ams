...
const fs = require('fs');
const { isEnabled: cloudinaryEnabled } = require('./cloudinary');
...
// Cloudinary mode: keep file in memory so we can stream-upload to Cloudinary
// Local mode: write directly to disk (for SQLite/local dev)
